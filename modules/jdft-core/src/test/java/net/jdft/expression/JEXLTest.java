...
//	}
	...
	public void testSequence() {
		JEXLExpression expression = new JEXLExpression();
		
		System.out.println(expression.execute(null, "sequence:nextValue(6,6)"));
	}
	
	public void testDateFormat() {
		JEXLExpression expression = new JEXLExpression();
		
		System.out.println(expression.execute(null, "dateFormat:format('yyyyMMddHHmmss')"));
	}
	public void testStringAppend() {
		JEXLExpression expression = new JEXLExpression();
		
		System.out.println(expression.execute(null, "'a' + 'b' +'c'"));
	}
	...
	public void testAppend() {
		...
		System.out.println(expression.execute(null, "dateFormat:format('yyyyMMddHHmmss').concat(sequence:nextValue(6,6))"));
	}
	
	public void testNew() {
		JEXLExpression expression = new JEXLExpression();
		
		Object obj = expression.execute(null, "dateFormat:format('yyyyMMddHHmmss')");
